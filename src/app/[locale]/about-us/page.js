        ...
        <div className="page-container">
            ...
            <div className="section">
                <div className="w-full mx-auto">
                    ...
                    TweetXPro was founded in 2022 by a group of tech enthusiasts who were frustrated with the limitations of downloading content from Twitter (now X). What started as a simple side project has grown into a trusted platform used by millions of users worldwide.
                    </p>
                    <p className="text-lg leading-relaxed mb-6">
                    ...
                    <p className="text-lg leading-relaxed mb-6">
                        Unlike other services, we've built TweetXPro with privacy and user experience in mind. We don't collect unnecessary data, we don't require registration, and we don't bombard users with ads. Our focus is solely on providing the best possible download experience.
                    </p>
